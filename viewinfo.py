...
def print_all_info():
    print("{}: {} ".format("Control", status_control))
    print("{}: {} {}".format("Temperature", status_temp, "0.1K"))
    print("{}: {} {}".format("Voltage", status_voltage, "mV"))
    print("{}: {} {}".format("Nominal Available Capacity", status_nom_capacity,"mAh"))
    print("{}: {} {}".format("Full Available Capacity", status_avail_capacity,"mAh"))
    print("{}: {} {}".format("Remaining Capacity", status_rem_capacity, "mAh"))
    print("{}: {} {}".format("Full Charge Capacity", status_full_capacity,"mAh"))
    print("{}: {} {}".format("Average Current", status_avg_current, "mA"))
    print("{}: {} {}".format("Standby Current", status_stdby_current, "mA"))
    print("{}: {} {}".format("MaxLoad Current", status_max_current, "mA"))
    print("{}: {} {}".format("Average Power", status_avg_power, "mW"))
    print("{}: {} {}".format("State Of Charge", status_soc, "%"))
    print("{}: {} {}".format("Internal Temperature", status_int_temp, "0.1K"))
    print("{}: {} {}".format("State Of Health", status_soh, "%"))
    print("{}: {} {}".format("Remaining Capacity Unfiltered",status_rem_cap_unfil, "mAh"))
    print("{}: {} {}".format("Remaining Capacity Filtered", status_rem_cap_fil,"mAh"))
    print("{}: {} {}".format("Full Charge Capacity Unfiltered",status_full_cap_unfil, "mAh"))
    print("{}: {} {}".format("Full Charge Capacity Filtered",status_full_cap_fil, "mAh"))
    print("{}: {} {}".format("State Of Charge Unfiltered", status_soc_unfl,"%"))
    print("{}: {} {}".format("True Remaining Capacity",status_truerem_capacity, "mAh"))
...
def print_basic_info():
    ...
    istr =  "Voltage:", float(battery_voltage) / 1000, "V - " \
        "Current:", float(battery_current) / 1000 , "A - " , \
        "SOC:", battery_soc , "%", time_str
    print(istr)
